...
namespace GameKit.Base
{
    public class SingletonParent : SingletonBehaviour<SingletonParent>
    {
        ...
        {
            GameFramework.Log.Info("SingletonBehaviour Step In SingletonParent ApplicationQuit");
    ...
    public class SingletonBehaviour<T> : MonoBehaviour where T : MonoBehaviour
    {
        ...
        public static T Instance
        {
            get
            {
                ...
                {
                    GameFramework.Log.Warning("[Singleton] Instance '" + typeof(T) +
                ...
                if (_instance == null)
                {
                    lock (_lock)
                    {
                        if (_instance == null)
                        {
                            ...
                            {
                                GameFramework.Log.Error("[Singleton] Something went really wrong " +
                            ...
                            if (_instance == null)
                            {
                                ...
                                GameFramework.Log.Info("[Singleton] An instance of " + typeof(T) +
                                    " is needed in the scene, so '" + singleton +
                                    "' was created with DontDestroyOnLoad.");
                            }
                            else
                            {
                                GameFramework.Log.Info("[Singleton] Using instance already created: " +
        ...
        {
            GameFramework.Log.Info("SingletonBehaviour [Release] " + gameObject.name);
        }
    ...
    public static class ComponentExtensions
    {
        ...
        public static void RemoveComponent<T>(this Component comp) where T : Component
        {
            if (comp == null)
                return;

            RemoveComponent<T>(comp.gameObject);
        }
    }
