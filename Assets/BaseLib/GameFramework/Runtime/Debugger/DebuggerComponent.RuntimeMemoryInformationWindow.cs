                    ...
                    else
                    {
                        ...
                        if (m_Samples.Count > 0)
                        {
                            GUILayout.BeginHorizontal();
                            {
                                ...
                                GUILayout.Label("<b>Type</b>", GUILayout.Width(200f));
                                GUILayout.Label("<b>Size</b>", GUILayout.Width(100f));
                            }
                        ...
                        for (int i = 0; i < m_Samples.Count; i++)
                        {
                            GUILayout.BeginHorizontal();
                            {
                                ...
                                {
                                    m_fontStyle.normal.textColor = Color.yellow;
                                }
                                else
                                {
                                ...
                                GUILayout.Label(m_Samples[i].Name, m_fontStyle);

                                m_fontStyle.fixedWidth = 200;
                                GUILayout.Label(m_Samples[i].Type, m_fontStyle);

                                m_fontStyle.fixedWidth = 100;
                                GUILayout.Label(GetSizeString(m_Samples[i].Size), m_fontStyle);
                            }
                            GUILayout.EndHorizontal();
