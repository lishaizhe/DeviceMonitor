...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        ...
        /// 默认调试器漂浮框大小。
        /// </summary>
        internal static readonly Rect DefaultIconRect = new Rect(0f, 0f, 80f, 80f);

        /// <summary>
        /// 默认调试器窗口大小。
        /// </summary>
        internal static readonly Rect DefaultWindowRect = new Rect(0f, 0f, 960f, 540f);
        ...
        private UITreeWindow m_UiTreeWindow = new UITreeWindow();
        ...
        private void Start()
        {
            ...
            RegisterDebuggerWindow("Information/Path", m_PathInformationWindow);
            RegisterDebuggerWindow("Information/Quality", m_QualityInformationWindow);
            RegisterDebuggerWindow("Information/System", m_SystemInformationWindow);
            RegisterDebuggerWindow("Information/Touch", m_InputTouchInformationWindow);
            RegisterDebuggerWindow("Information/UITree", m_UiTreeWindow);
            ...
            RegisterDebuggerWindow("Object Pool", m_ObjectPoolInformationWindow);
...
//#endif
        ...
        private void DrawDebuggerWindowGroup(IDebuggerWindowGroup debuggerWindowGroup)
        {
            ...
            int toolbarIndex = GUILayout.Toolbar(debuggerWindowGroup.SelectedIndex, names.ToArray(), GUILayout.Height(45f), GUILayout.MaxWidth(Screen.width));
        ...
        private void DrawDebuggerWindowIcon(int windowId)
        {
            ...
            if (GUILayout.Button(title, GUILayout.Width(120f), GUILayout.Height(40f)))
            {
                m_ShowFullWindow = true;
            }
        }
        
        public void MakeAMark()
        {
            StackTrace insStackTrace = new StackTrace(true);
            StackFrame insStackFrame = insStackTrace.GetFrame(1); 
            UnityEngine.Debug.LogFormat("File: {0}, Line: {1}", insStackFrame.GetFileName(), insStackFrame.GetFileLineNumber());
        }
    }
}
