    ...
    public partial class DebuggerComponent
    {
        private sealed class SettingsWindow : ScrollableDebuggerWindowBase
        {
            ...
            public override void Initialize(params object[] args)
            {
                ...
                m_LastIconX = m_SettingComponent.GetPublicFloat("Debugger.Icon.X", DefaultIconRect.x);
                m_LastIconY = m_SettingComponent.GetPublicFloat("Debugger.Icon.Y", DefaultIconRect.y);
                m_LastWindowX = m_SettingComponent.GetPublicFloat("Debugger.Window.X", DefaultWindowRect.x);
                m_LastWindowY = m_SettingComponent.GetPublicFloat("Debugger.Window.Y", DefaultWindowRect.y);
                m_LastWindowWidth = m_SettingComponent.GetPublicFloat("Debugger.Window.Width", DefaultWindowRect.width);
                m_LastWindowHeight = m_SettingComponent.GetPublicFloat("Debugger.Window.Height", DefaultWindowRect.height);
                m_DebuggerComponent.WindowScale = m_LastWindowScale = m_SettingComponent.GetPublicFloat("Debugger.Window.Scale", DefaultWindowScale);

                if (m_LastIconX < 0) m_LastIconX = 0;
                if (m_LastIconY < 0) m_LastIconY = 0;
                if (m_LastWindowX < 0) m_LastWindowX = 0;
                if (m_LastWindowY < 0) m_LastWindowY = 0;
