...
namespace GameFramework
{
    ...
    public static class GameFrameworkEntry
    {
        ...
        private static LinkedList<GameFrameworkModule>.Enumerator enumerator;
        ...
        {
            // FIXME: 如果某个组件在update的时候更新了链表会不会有问题？所以这里先简单判断一下
            enumerator = s_GameFrameworkModules.GetEnumerator();
        ...
        private static GameFrameworkModule CreateModule(Type moduleType)
        {
            ...
            //Debug.LogFormat("create module '{0}'.", module.GetType().FullName);
