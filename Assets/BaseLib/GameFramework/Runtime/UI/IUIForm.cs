...
namespace GameFramework.UI
{
    ...
    public interface IUIForm
    {
		...
		/// Sets the invisible.
		/// </summary>
		/// <param name="canInvisible">If set to <c>true</c> can invisible.</param>
		...
		void OnInit(int serialId, string uiKey, string uiFormAssetName, IUIGroup uiGroup, bool pauseCoveredUIForm, object userData,params object[] backArgs);
